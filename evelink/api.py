...
class API(object):
    ...
    def __init__(self, base_url="api.eveonline.com", cache=None, api_key=None):
        ...
        # Contains the difference between currentTime and cachedUntil
        # for the last API request that was made using this API object.
        # Mostly provided as a way of exposing how long data will be cached
        # for to those who really care about it.
        self.last_cache_duration = None
    ...
    def get(self, path, params=None):
        ...
        cache_duration = expires_time - current_time
        self.cache.put(key, result, cache_duration)
        self.last_cache_duration = cache_duration
